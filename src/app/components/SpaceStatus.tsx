...
const sourceLabel = {
  PROPRIO_ESPACO: "Conflito no próprio espaço",
  PAI: "Bloqueado por espaço pai",
  FILHO: "Bloqueado por subespaço",
  FILHOS_OCUPADOS: "Todos os subespaços ocupados",
} as const;
  ...
  return (
    <div className="rounded-xl border border-gray-100 bg-white p-6 dark:border-slate-800 dark:bg-slate-950">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-slate-400">A disponibilidade considera o espaço atual, a hierarquia e a origem do bloqueio.</p>
      </div>
