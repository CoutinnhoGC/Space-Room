import { CalendarRange, Clock3, Eye, Edit2, FileText, Filter, Layers3, Plus, Search, Trash2, User2, X, XCircle } from "lucide-react";
...
export function ReservasPage() {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    if (hasConflict) {
      toast.error("Já existe uma reserva para esse espaço ou subespaço no intervalo selecionado.");
      return;
    }
        ...
        <div className="mb-6 rounded-xl border border-gray-100 bg-white p-6 dark:border-slate-800 dark:bg-slate-950">
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-slate-400">{panelMode === "quick" ? "Preencha os campos essenciais para registrar uma reserva imediata." : "Atualize os dados da reserva mantendo o fluxo já existente."}</p>
            </div>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              <label className="mb-2 block text-sm font-medium text-gray-700 dark:text-slate-300">Título <span className="text-red-500">*</span></label>
